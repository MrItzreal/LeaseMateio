...
@OpenAPIDefinition(
   info = @Info(
      title = "LeaseMateIO API", 
      version = "1.0", 
      description = "This API exposes endpoints to managed properties, apartments, and tenants.", 
   contact = @Contact(
      name = "Call Me Izzy!", 
      email = "[No Personal Email]", 
      url = "https://x.com/fullstackizzy"), 
   license = @License(
      name = "MIT License", 
      url = "https://choosealicense.com/licenses/mit/"), 
      termsOfService = "https://x.com/fullstackizzy"), 
   servers = @Server(
      url = "http://localhost:8080", 
      description = "Server URL in Local development environment"),
